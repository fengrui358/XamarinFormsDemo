...
namespace XamarinFormsDemo.Views
{
    public partial class AreaSelectView : ContentPage
    {
        ...
        public AreaSelectView()
        {
            ...
            _entry = new Entry { HorizontalOptions = LayoutOptions.FillAndExpand, Placeholder = "搜索", BackgroundColor = Color.White, IsEnabled = true };
        ...
        private void EntryOnFocused(object sender, FocusEventArgs focusEventArgs)
        {
            ...
            {
                AbsoluteLayout.SetLayoutBounds(_areaSelectedPlane, new Rectangle(0, Height - 300, AbsoluteLayout.AutoSize, 300));
            }
        }
        ...
        protected override void OnAppearing()
        {
            ...
            absoluteLayout.Children.Add(_areaSelectedPlane, new Rectangle(0, DeviceInfo.Height, AbsoluteLayout.AutoSize, 300));
